...
public class InferenceSettings
{
    ...
    public string SystemPrompt { get; set; } = """
            ...
            `"suggested_change"` can be omitted if "has_change" is false, otherwise it must be populated (it MUST NOT be null).
            `"comment"` can also be omitted if "has_change" is false or if the suggested change is trivial.
